...
RNA_10<-read_tsv("c:/users/Jawairia/Documents/MICB425_portfolio/gcloud raw outputs/10m/10m_RNA/final_outputs/marker_contig_map.tsv")%>%
  select(Tax.RNA.10 = Confident_Taxonomy, Abund.RNA.10 = Abundance, Query)
RNA_100<-read_tsv("~/MICB425_portfolio/gcloud raw outputs/100m/100m_RNA/final_outputs/marker_contig_map.tsv")%>%
  select(Tax.RNA.100 = Confident_Taxonomy, Abund.RNA.100 = Abundance, Query)
RNA_120 <-read_tsv("~/MICB425_portfolio/gcloud raw outputs/120m/120m_RNA/final_outputs/marker_contig_map.tsv")%>%
  select(Tax.RNA.120 = Confident_Taxonomy, Abund.RNA.120 = Abundance, Query)
RNA_135 <-read_tsv("~/MICB425_portfolio/gcloud raw outputs/135m/135m_RNA/final_outputs/marker_contig_map.tsv")%>%
  select(Tax.RNA.135= Confident_Taxonomy, Abund.RNA.135= Abundance, Query)
RNA_150 <-read_tsv("~/MICB425_portfolio/gcloud raw outputs/150m/150m_RNA/final_outputs/marker_contig_map.tsv")%>%
  select(Tax.RNA.150= Confident_Taxonomy, Abund.RNA.150= Abundance, Query)
RNA_165 <-read_tsv("~/MICB425_portfolio/gcloud raw outputs/165m/165m_RNA/final_outputs/marker_contig_map.tsv")%>%
  select(Tax.RNA.165= Confident_Taxonomy, Abund.RNA.165= Abundance, Query)
RNA_200 <-read_tsv("~/MICB425_portfolio/gcloud raw outputs/200m/200m_RNA/final_outputs/marker_contig_map.tsv")%>%
...
DNA_10<-read_tsv("~/MICB425_portfolio/gcloud raw outputs/10m/10m_DNA/final_outputs/marker_contig_map.tsv")%>%
  select(Tax.DNA.10 = Confident_Taxonomy, Abund.DNA.10 = Abundance, Query)
DNA_100<-read_tsv("~/MICB425_portfolio/gcloud raw outputs/100m/100m_DNA/final_outputs/marker_contig_map.tsv")%>%
  select(Tax.DNA.100 = Confident_Taxonomy, Abund.DNA.100 = Abundance, Query)
DNA_120 <-read_tsv("~/MICB425_portfolio/gcloud raw outputs/120m/120m_DNA/final_outputs/marker_contig_map.tsv")%>%
  select(Tax.DNA.120 = Confident_Taxonomy, Abund.DNA.120 = Abundance, Query)
DNA_135 <-read_tsv("~/MICB425_portfolio/gcloud raw outputs/135m/135m_DNA/final_outputs/marker_contig_map.tsv")%>%
  select(Tax.DNA.135= Confident_Taxonomy, Abund.DNA.135= Abundance, Query)
DNA_150 <-read_tsv("~/MICB425_portfolio/gcloud raw outputs/150m/150m_DNA/final_outputs/marker_contig_map.tsv")%>%
  select(Tax.DNA.150= Confident_Taxonomy, Abund.DNA.150= Abundance, Query)
DNA_165 <-read_tsv("~/MICB425_portfolio/gcloud raw outputs/165m/165m_DNA/final_outputs/marker_contig_map.tsv")%>%
  select(Tax.DNA.165= Confident_Taxonomy, Abund.DNA.165= Abundance, Query)
DNA_200 <-read_tsv("~/MICB425_portfolio/gcloud raw outputs/200m/200m_DNA/final_outputs/marker_contig_map.tsv")%>%
...
RNA_10m<-read.delim("~/MICB425_portfolio/gcloud raw outputs/10m/10m_RNA/final_outputs/marker_contig_map.tsv", na.strings=c(""))
...
RNA_100m<-read.delim("~/MICB425_portfolio/gcloud raw outputs/100m/100m_RNA/final_outputs/marker_contig_map.tsv", na.strings=c(""))
...
RNA_120m<-read.delim("~/MICB425_portfolio/gcloud raw outputs/120m/120m_RNA/final_outputs/marker_contig_map.tsv", na.strings=c(""))
...
RNA_135m<-read.delim("~/MICB425_portfolio/gcloud raw outputs/135m/135m_RNA/final_outputs/marker_contig_map.tsv", na.strings=c(""))
...
RNA_150m<-read.delim("~/MICB425_portfolio/gcloud raw outputs/150m/150m_RNA/final_outputs/marker_contig_map.tsv", na.strings=c(""))
...
RNA_165m<-read.delim("~/MICB425_portfolio/gcloud raw outputs/165m/165m_RNA/final_outputs/marker_contig_map.tsv", na.strings=c(""))
...
RNA_200m<-read.delim("~/MICB425_portfolio/gcloud raw outputs/200m/200m_RNA/final_outputs/marker_contig_map.tsv", na.strings=c(""))
...
DNA_10m<-read.delim("~/MICB425_portfolio/gcloud raw outputs/10m/10m_DNA/final_outputs/marker_contig_map.tsv", na.strings=c(""))
...
DNA_100m<-read.delim("~/MICB425_portfolio/gcloud raw outputs/100m/100m_DNA/final_outputs/marker_contig_map.tsv", na.strings=c(""))
...
DNA_120m<-read.delim("~/MICB425_portfolio/gcloud raw outputs/120m/120m_DNA/final_outputs/marker_contig_map.tsv", na.strings=c(""))
...
DNA_135m<-read.delim("~/MICB425_portfolio/gcloud raw outputs/135m/135m_DNA/final_outputs/marker_contig_map.tsv", na.strings=c(""))
...
DNA_150m<-read.delim("~/MICB425_portfolio/gcloud raw outputs/150m/150m_DNA/final_outputs/marker_contig_map.tsv", na.strings=c(""))
...
DNA_165m<-read.delim("~/MICB425_portfolio/gcloud raw outputs/165m/165m_DNA/final_outputs/marker_contig_map.tsv", na.strings=c(""))
...
DNA_200m<-read.delim("~/MICB425_portfolio/gcloud raw outputs/200m/200m_DNA/final_outputs/marker_contig_map.tsv", na.strings=c(""))
...
```{r message=FALSE, warning=FALSE, paged.print=FALSE, results="hide"}
RNA_10<-read_tsv("~/MICB425_portfolio/gcloud raw outputs/10m/10m_RNA/final_outputs/marker_contig_map.tsv")%>%
  select(Tax.RNA.10 = Confident_Taxonomy, Abund.RNA.10 = Abundance, Query)
RNA_100<-read_tsv("~/MICB425_portfolio/gcloud raw outputs/100m/100m_RNA/final_outputs/marker_contig_map.tsv")%>%
  select(Tax.RNA.100 = Confident_Taxonomy, Abund.RNA.100 = Abundance, Query)
RNA_120 <-read_tsv("~/MICB425_portfolio/gcloud raw outputs/120m/120m_RNA/final_outputs/marker_contig_map.tsv")%>%
